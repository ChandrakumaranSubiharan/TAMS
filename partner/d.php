...
<body>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				...
				<img src="../assets/dashboard/vendors/images/deskapp-logo-white.svg" alt="" class="light-logo">
			</a>
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="../assets/dashboard/vendors/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assets/dashboard/vendors/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assets/dashboard/vendors/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assets/dashboard/vendors/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assets/dashboard/vendors/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>
	...
	<!-- js -->
	<script src="../assets/dashboard/vendors/scripts/core.js"></script>
	<script src="../assets/dashboard/vendors/scripts/script.min.js"></script>
	<script src="../assets/dashboard/vendors/scripts/process.js"></script>
	<script src="../assets/dashboard/vendors/scripts/layout-settings.js"></script>
	<script src="../assets/dashboard/src/plugins/apexcharts/apexcharts.min.js"></script>
	<script src="../assets/dashboard/src/plugins/datatables/js/jquery.dataTables.min.js"></script>
