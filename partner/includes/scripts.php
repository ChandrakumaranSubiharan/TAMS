	...
	<script src="../assets/dashboard/src/plugins/datatables/js/buttons.print.min.js"></script>
	<script src="../assets/dashboard/src/plugins/datatables/js/buttons.html5.min.js"></script>
	<script src="../assets/dashboard/src/plugins/datatables/js/buttons.flash.min.js"></script>
	<script src="../assets/dashboard/src/plugins/datatables/js/pdfmake.min.js"></script>
