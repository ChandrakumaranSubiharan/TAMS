...
class earning
{
  ...
  public function insertEarningData($pid,$tot,$payout,$net,$cid)
  {
    ...
    $query = "INSERT INTO tbl_earning(partner_id, total_amount, payout, net_amount, customer_id,created_date)
                 VALUES('$pid','$tot','$payout','$net','$cid','$cdate')";
