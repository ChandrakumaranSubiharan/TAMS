        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Customer Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $CustomerView = $reports->CustomersReport($Rtype, $SDate, $EDate, $Type);
                }
                ?>
                                        ...
                                        ?>
                                            <option value="<?php if (isset($_POST['submit'])) {
                                                ...
                                                <?php if (isset($_POST['submit']) && $Rtype == 1) {
                                                    echo 'Customers Report : Selected';
                                                } elseif ($Rtype == 2) {
                                                    echo 'Top Customers Report : Selected';
                                                };?>
                                            </option>
                                        <?php
                                        }
                                        ?>
                                        <option value="1">Customers Report</option>
                                        <option value="2">Top Customers Report</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Total Bookings Made</th>
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $Customerdata = $reports->CustomersReport($Rtype, $SDate, $EDate, $Type);
                                if ($Customerdata) {

                                    foreach ($Customerdata as $Customerdatas) {
                            ?>
                                        <tr>
                                            <td scope="row"><?= $Customerdatas['customer_id']; ?></td>
                                            <td><?= $Customerdatas['first_name'], ' ', $Customerdatas['last_name']; ?></td>
                                            <td><?= $Customerdatas['email_address']; ?></td>
                                            <td><?= $Customerdatas['address']; ?></td>
                                            <td><?= $Customerdatas['contact_number']; ?></td>
                                            <td><?= $Customerdatas['COUNT(DISTINCT tbl_booking.booking_id)']; ?></td>
                                            <td><?php if ($Customerdatas['status'] == 0) {
                                                    echo "<span style='color: red;'>Inactive</span>";
                                                } elseif ($Customerdatas['status'] == 1) {
                                                    echo "<span style='color: green;'>Active</span>";
                                                } ?></td>
                                            <td><?= date('jS F, Y', strtotime($Customerdatas['created_date'])); ?></td>
