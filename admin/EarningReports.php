        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $ReportView = $reports->EarningReportAll($Rtype, $SDate, $EDate, $Type);
                }
                ?>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select2 form-control" name="ReportType" style=" height: 38px;">
                                        ...
                                        ?>
                                            <option value="<?php if (isset($_POST['submit'])) {
                                                ...
                                                <?php if (isset($_POST['submit']) && $Rtype == 1) {
                                                    ...
                                                    echo 'Profit Percentage Greaterthan 15% Report : Selected';
                                                } elseif ($Rtype == 7) {
                                                    echo 'Profit Percentage Lowerthan 15% Report : Selected';
                                                }; ?>
                                            </option>
                                        <?php
                                        }
                                        ...
                                        <option value="6">Profit Percentage Greaterthan 15% Report</option>
                        ...
                        <h3 class="text-center">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                ...
                                if ($Rtype == 2) {
                                    ...
                                    echo 'Profit Percentage Greaterthan 15%';
                                } elseif ($Rtype == 7) {
                                    echo 'Profit Percentage Lowerthan 15%';
                                };
                            }
                            ?>
                            Earning Report</h3>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $Reportdata = $reports->EarningReportAll($Rtype, $SDate, $EDate, $Type);
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><?= $Reportdatas['net_amount']; ?> LKR</td>
                                            <td><?= $Reportdatas['profit_percentage'] ?> %</td>
                                            ...
                                            <?php
                                            if ($Reportdata) {
                                                $TotalIncome += $Reportdatas['net_amount'];
                                            }
                                            ?>
                                        </tr>
                                    <?php
